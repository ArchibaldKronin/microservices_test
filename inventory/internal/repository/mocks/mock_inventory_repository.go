...
import (
	...
	model "github.com/ArchibaldKronin/microservices_test/inventory/internal/model"
...
func (_m *InventoryRepository) ListParts(_a0 context.Context, _a1 *model.PartsFilter) ([]*model.Part, error) {
	ret := _m.Called(_a0, _a1)
...
func (_e *InventoryRepository_Expecter) ListParts(_a0 interface{}, _a1 interface{}) *InventoryRepository_ListParts_Call {
	return &InventoryRepository_ListParts_Call{Call: _e.mock.On("ListParts", _a0, _a1)}
}

func (_c *InventoryRepository_ListParts_Call) Run(run func(_a0 context.Context, _a1 *model.PartsFilter)) *InventoryRepository_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
