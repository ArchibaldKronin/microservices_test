...
func (_m *InventoryService) ListParts(_a0 context.Context, _a1 *model.PartsFilter) ([]*model.Part, error) {
	ret := _m.Called(_a0, _a1)
...
func (_e *InventoryService_Expecter) ListParts(_a0 interface{}, _a1 interface{}) *InventoryService_ListParts_Call {
	return &InventoryService_ListParts_Call{Call: _e.mock.On("ListParts", _a0, _a1)}
}

func (_c *InventoryService_ListParts_Call) Run(run func(_a0 context.Context, _a1 *model.PartsFilter)) *InventoryService_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
