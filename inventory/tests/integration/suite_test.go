...
var (
	...
	suiteCtx    context.Context    //nolint: containedctx
	suiteCancel context.CancelFunc //nolint: containedctx
)
...
var _ = BeforeSuite(func() {
	...
	envVars, err := godotenv.Read(filepath.Join(path.GetProjectRoot(), "deploy", "compose", "inventory", ".env"))
	if err != nil {
