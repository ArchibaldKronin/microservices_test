...
// PayOrder provides a mock function with given fields: ctx, userId, orderId, paymentMethod
func (_m *PaymentClient) PayOrder(ctx context.Context, userId string, orderId string, paymentMethod model.PaymentMethod) (string, error) {
...
func (_e *PaymentClient_Expecter) PayOrder(ctx interface{}, userId interface{}, orderId interface{}, paymentMethod interface{}) *PaymentClient_PayOrder_Call {
	return &PaymentClient_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, userId, orderId, paymentMethod)}
}

func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, userId string, orderId string, paymentMethod model.PaymentMethod)) *PaymentClient_PayOrder_Call {
...
func (_c *PaymentClient_PayOrder_Call) Return(transactionId string, err error) *PaymentClient_PayOrder_Call {
