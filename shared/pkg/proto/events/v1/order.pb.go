...
// Событие оплаты заказа OrderPaid
...
// Событие успешного создания корабля ShipAssembled
...
const file_events_v1_order_proto_rawDesc = "" +
	...
	"\x1dPAYMENT_METHOD_INVESTOR_MONEY\x10\x04BTZRgithub.com/ArchibaldKronin/microservices_test/shared/pkg/proto/events/v1;events_v1b\x06proto3"
...
var file_events_v1_order_proto_goTypes = []any{
	...
	(*ShipAssembled)(nil), // 2: events.v1.ShipAssembled
}
