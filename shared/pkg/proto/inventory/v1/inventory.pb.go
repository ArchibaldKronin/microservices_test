...
// фильтр для получения запчастей
...
func (x *PartsFilter) GetCategorys() []Category {
	if x != nil {
		return x.Categorys
	}
	return nil
...
func (x *PartsFilter) GetCountrys() []string {
	if x != nil {
		return x.Countrys
	}
	return nil
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x06filter\x18\x01 \x01(\v2\x19.inventory.v1.PartsFilterR\x06filter\"\x9f\x01\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBZZXgithub.com/ArchibaldKronin/microservices_test/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	0,  // 8: inventory.v1.PartsFilter.categorys:type_name -> inventory.v1.Category
